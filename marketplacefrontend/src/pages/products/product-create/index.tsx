...
import ProductsApiService from 'util/services/ProductsApiService';
import { log } from 'console'
const CreateProduct = () => {
    document.title = "Create Product | Toner eCommerce + Admin React Template";

    const [selectedFiles, setselectedFiles] = useState([]);
    const [product_tilte, setProductTitle] = useState('');
    const [choices_category, setChoicesCategory] = useState({});
    const [manufacturer_name,setManufacturerName] =useState('');
    const [manufacturer_brand,setManufacturerBrand] =useState('');
    ...
    const handleswitch=(e :any) => {
        switch (e.target.name) {
            case 'product_tilte':
                setProductTitle(e.target.value);
                break;
            case 'choices-category-input':
                setChoicesCategory(e.target.value);
                break;
            case 'man-name':
                setManufacturerName(e.target.value);
                break;
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        let data_product = {
        product_tilte: product_tilte,
        category_id:choices_category,
        custom_fields: {
        ...
        ProductsApiService.createProduct(data_product)
                .then ((response: any) => {
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    ...
                    <Form onSubmit={handleSubmit} id="createproduct-form" autoComplete="off" className="needs-validation" noValidate>
                        <Row>
                            <Col xl={9} lg={8}>
                                <Card>
                                    <Card.Header>
                                    ...
                                    <Card.Body>
                                        <div className="mb-3">
                                            ...
                                            <Form.Control type="text" name="product-title" id="product-title-input" defaultValue="" placeholder="Enter product title" required onChange={handleInputChange} />
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <select className="form-select" id="choices-category-input" name="choices-category-input"  /*</div>onChange={(e)=>setChoicesCategory(e.target.value)}*/ >
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mb-3">
                                                    ...
                                                    <Form.Control name='man-name' type="text" id="manufacturer-name-input" placeholder="Enter manufacturer name"  required onChange={handleInputChange} />
                                                </div>
                                            </Col>
                                            <Col lg={6}>
                                                <div className="mb-3">
                                                    <Form.Label htmlFor="manufacturer-brand-input">Manufacturer Brand</Form.Label>
                                                    <Form.Control name='man-brand' type="text" id="manufacturer-brand-input" placeholder="Enter manufacturer brand" required onChange={handleInputChange} />
                                                </div>
                                            </Col>
                                        </Row>
                                        <Row>
                                            <Col lg={3} sm={6}>
                                                <div className="mb-3">
                                                    ...
                                                    <Form.Control name='stocks' type="text" id="stocks-input" placeholder="Stocks" required onChange={handleInputChange} />
                                            ...
                                            <Col lg={3} sm={6}>
                                                <div className="mb-3">
                                                    ...
                                                    <div className="input-group has-validation mb-3">
                                                        ...
                                                        <Form.Control  name='prices' type="text" id="product-price-input" placeholder="Enter price" aria-label="Price" aria-describedby="product-price-addon" required onChange={handleInputChange}/>
                                            ...
                                            <Col lg={3} sm={6}>
                                                <div className="mb-3">
                                                    ...
                                                    <div className="input-group has-validation mb-3">
                                                        ...
                                                        <Form.Control name='discount' type="text" id="product-discount-input" placeholder="Enter discount" aria-label="discount" aria-describedby="product-discount-addon" required onChange={handleInputChange}/>
                                            ...
                                            <Col lg={3} sm={6}>
                                                <div className="mb-3">
                                                    ...
                                                    <Form.Control name='orders' type="text" id="orders-input" placeholder="Orders" required onChange={handleInputChange} />
